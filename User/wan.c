...
int AfterCircle(void)
{
	...
	{
		case 0:
			StaightCLose(1850, 0, 0, 1800);
			if(Position_t.Y > 3200)
				step++;
			break;
		case 1:
			StaightCLose(0, 4200, 90, 1800);
			if(Position_t.X < -800)
				step++;
			break;
		case 2:
			StaightCLose(-1800, 0, 180, 1800);
			if(Position_t.Y < 1600)
				step++;
			break;
		case 3:
			StaightCLose(0, 600, -90, 1800);
			if(Position_t.X > 800)
				step++;
			break;
		case 4:
			StaightCLose(1800, 0, 0, 1800);
